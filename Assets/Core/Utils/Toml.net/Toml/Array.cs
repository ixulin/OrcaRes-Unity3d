    ...
    public class Array : Entry
    {
        ...
        public void UpdateSourceText()
        {
            ...
            (
                ...
                String.Join(Parser.Tokens.ArraySeparator.ToString(), (this.Children.Select(c => c.SourceText)).ToArray<string>()),
        ...
        public override string ToString()
        {
            ...
            valueText.Append(string.Join(Parser.Tokens.ArraySeparator + " ", (this.Children.Select(c => c.ToString()).ToArray<string>())));
