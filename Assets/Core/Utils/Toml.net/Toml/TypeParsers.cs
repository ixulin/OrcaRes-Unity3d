...
namespace Toml
{
    public static class TypeParsers
    {
        ...
        private static Dictionary<Type, Func<string, ParseResultBase>> RegisterParsers()
        {
            ...
            parsers.Add(typeof(UnityEngine.Vector3), ParseVector3);
            parsers.Add(typeof(UnityEngine.Rect), ParseRect);
        ...
        private static ParseResult<UnityEngine.Vector3> ParseVector3(string value)
        {
            try
            {
                return new ParseResult<UnityEngine.Vector3>(Orca.OrcaUtil.String2Vec3(value));
            }
            catch (Exception ex)
            {
                return new ParseResult<UnityEngine.Vector3>(ex);
            }
        }

        private static ParseResult<UnityEngine.Rect> ParseRect(string value)
        {
            try
            {
                return new ParseResult<UnityEngine.Rect>(Orca.OrcaUtil.String2Rect(value));
            }
            catch (Exception ex)
            {
                return new ParseResult<UnityEngine.Rect>(ex);
            }
        }
